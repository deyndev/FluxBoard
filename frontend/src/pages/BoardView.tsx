        ...
        <div className="flex items-center gap-3">
          ...
          <Dropdown trigger={
            ...
            <DropdownItem 
              icon={<Edit2 />} 
              onClick={() => {
                const newTitle = prompt("Rename Board", localBoard.title);
                if (newTitle && newTitle !== localBoard.title) {
                      ...
                      >
                        ...
                        >
                          <DropdownItem 
                            ...
                            variant="danger" 
                            onClick={() => {
                              if(confirm('Delete this column?')) deleteColumnMutation.mutate(column.id);
                            }}
                          >
                            Delete Column
                          </DropdownItem>
                          ...
                          >
                                ...
                                >
                                  {(provided, snapshot) => (
                                    <div
                                      ...
                                      className={`glass-card p-4 rounded-xl mb-3 relative group ${
                                        snapshot.isDragging ? 'shadow-2xl ring-1 ring-primary/50 rotate-1 z-50 bg-[#161b22]' : 'bg-[#161b22]/40 hover:bg-[#161b22]/60'
                                      } ${
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (content) addCardMutation.mutate({ colId: column.id, content });
                              }}
